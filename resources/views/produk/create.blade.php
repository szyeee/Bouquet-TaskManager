...
@section('content')
<div class="container">
  <h1 class="mb-6 text-2xl font-semibold text-gray-900 dark:text-gray-100">Tambah Produk</h1>
  ...
  <div class="bg-pink-50 dark:bg-gray-800 shadow rounded-lg p-6 space-y-6">
    <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
      ...
      {{-- Foto --}}
      <div>
        <label for="foto" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Foto Produk</label>
        <input 
          type="file" 
          id="foto" 
          name="foto" 
